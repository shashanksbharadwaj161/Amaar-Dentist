          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    _model.error = await actions.signInWithPhone(
                    ...
                    if (_model.error == null || _model.error == '') {
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text('Error with Signing In!'),
                ...
                InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed(PhoneCreateAccountWidget.routeName);
                  },
                  child: Text(
                    FFLocalizations.of(context).getText(
                      '6yrxzhhc' /* register */,
