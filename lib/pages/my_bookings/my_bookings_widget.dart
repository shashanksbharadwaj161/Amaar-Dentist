  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<PatientsInfoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PatientsInfoRow> myBookingsPatientsInfoRowList = snapshot.data!;

        final myBookingsPatientsInfoRow =
            myBookingsPatientsInfoRowList.isNotEmpty
                ? myBookingsPatientsInfoRowList.first
                : null;
                                                      ...
                                                      children: [
                                                        ...
                                                        FutureBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            List<DoctorsInfoRow>
                                                                rowDoctorsInfoRowList =
                                                                snapshot.data!;

                                                            final rowDoctorsInfoRow =
                                                                rowDoctorsInfoRowList
                                                                        .isNotEmpty
                                                                    ? rowDoctorsInfoRowList
                                                                        .first
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewBookingsRow.docLocation,
                                                                            '.',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
