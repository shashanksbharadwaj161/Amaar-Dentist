...
import '/components/cancel_confirm/cancel_confirm_widget.dart';
...
class CancelBookingWidget extends StatefulWidget {
  ...
  final BookingsRow? bookingcancel;
  final int? cntApp;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    FFLocalizations.of(context).getText(
                      'z4sqtxyx' /* Please select the reason for c... */,
                    ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowRadioButton(
                      options: [
                        FFLocalizations.of(context).getText(
                          'pixnxmkm' /* Schedule change */,
                        ),
                        FFLocalizations.of(context).getText(
                          'mpbp8p8k' /* Weather conditions */,
                        ),
                        FFLocalizations.of(context).getText(
                          '6m8yufhy' /* Unexpected work */,
                        ),
                        FFLocalizations.of(context).getText(
                          '5c8eu20b' /* Childcare issues */,
                        ),
                        FFLocalizations.of(context).getText(
                          '95uoa8s3' /* Travel delays */,
                        ),
                        FFLocalizations.of(context).getText(
                          'g7w9ofnn' /* Other */,
                        )
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  height: 350.0,
                                  child: CancelConfirmWidget(
                                    bookin: widget.bookingcancel!,
                                    cancelreason: _model.radioButtonValue!,
                                    cntApp: widget.cntApp!,
                                  ),
                                ),
                              ),
                            );
